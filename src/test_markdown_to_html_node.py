...
"""
        self.assertEqual(mark_down_to_html_node(markdown).to_html(), "<div><h1>This is a heading level 1</h1><p>This is a paragraph with <b>bold</b> and <i>italic</i> words<br />This is the same paragraph on the new line with <a href=\"https://www.google.com\">link</a></p><ul><li>unordered list item 1</li><li>unordered list item 2</li></ul><ul><li>unordered list item 1</li><li>unordered list item 2</li></ul><ol><li>ordered list item 1</li><li>ordered list item 2</li></ol><pre><code>def greet_person(name):&NewLine;    print(f\"Hello, {name}\")&NewLine;&NewLine;greet_person(\"john\")</code></pre><blockquote>This is a block quote with <b>bold</b> word</blockquote><blockquote>This is a block quote with <i>italic</i> word</blockquote></div>")
